...
class CartTileWidget extends StatelessWidget {
  ...
  CartTileWidget(
      {super.key, required this.productDataModel, required CartBloc cartBloc});
            ...
            children: [
              ...
              Row(
                children: [
                  IconButton(
                      onPressed: () {
                        // wishlistBloc.add(RemoveWishlistItem( clickedItems: productDataModel));
                      },
                      icon: const Icon(Icons.favorite_border_outlined)),
                  IconButton(
                    onPressed: () {
                      cartBloc.add(RemoveCartItems(
                          clickedToRemoveCartItems: productDataModel));
                    },
